  ...
  return (
    <section className="py-16 sm:py-24 px-4">
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col items-center gap-8 rounded-xl bg-gradient-to-br from-card/80 to-card/40 border border-border backdrop-blur-sm px-6 py-12 sm:px-10 sm:py-16 shadow-2xl">
          {/* Heading */}
