...
URL="$BASE_URL/factory-cli/releases/$VER/$platform/$architecture/$binary_name"
SHA_URL="$BASE_URL/factory-cli/releases/$VER/$platform/$architecture/$binary_name.sha256"
RG_URL="$BASE_URL/ripgrep/$platform/$architecture/$rg_binary_name"
RG_SHA_URL="$BASE_URL/ripgrep/$platform/$architecture/$rg_binary_name.sha256"
